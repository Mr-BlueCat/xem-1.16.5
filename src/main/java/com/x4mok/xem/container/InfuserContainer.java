...
public class InfuserContainer extends Container {
    ...
    public InfuserContainer(int windowId, World world, BlockPos pos,
        ...
        if(tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 0, 16, 35));
                addSlot(new SlotItemHandler(h, 1, 55, 26));
                addSlot(new SlotItemHandler(h, 2, 73, 26));
                addSlot(new SlotItemHandler(h, 3, 55, 44));
                addSlot(new SlotItemHandler(h, 4, 73, 44));
