...
public class StationStructure extends Structure<NoFeatureConfig> {
    public StationStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return StationStructure.Start::new;
    }
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(
                            () -> dynamicRegistries.registry(Registry.TEMPLATE_POOL_REGISTRY)
                                    .get().get(new ResourceLocation(XEM.MODID, "station/start_pool")),
                            10
                    ),
